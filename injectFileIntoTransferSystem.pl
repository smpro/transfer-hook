#!/usr/bin/env perl
# $Id: injectFileIntoTransferSystem.pl,v 1.45 2009/10/29 16:28:42 loizides Exp $
...
my ($help, $debug, $hostname, $filename, $hltkey, $pathname, $index, $indexsize, $filesize, $test);
